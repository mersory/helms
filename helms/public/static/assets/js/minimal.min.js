var widthLess1024 = function() {
	$("body .navbar .navbar-nav.side-nav>li.collapsed-content").hide();
	...
	$(".sidebar-collapse a").on(
			...
			function() {
				...
				if ($("#sidebar").hasClass("collapsed")) {
					...
					if ($(window).width() < 1024) {
						$("body .navbar .navbar-nav.side-nav>li.collapsed-content").show();
						$("#content").animate({
							left : "210px"
						}, 150)
					} else {
				...
				.videobackground(
						{
							videoSource : [
									[
											"https://tattek.com/minimal/assets/videos/videobg.mp4",
											"video/mp4" ],
									[
											"https://tattek.com/minimal/assets/videos/videobg.webm",
											"video/webm" ],
									[
											"https://tattek.com/minimal/assets/videos/videobg.ogv",
											"video/ogg" ] ],
