<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"C:\xampp\htdocs\tp5\public/../application/framework\view\useropt\loginindex.html";i:1505145301;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
          ...
          <div class="inside-block">
            ...
            <form action="UserLogin" method="post">
              ...
              <section class="log-in">
                <button class="btn btn-greensea" value="submitBtn" onclick="return validate();">登录</button>
              </section>
            </form>
