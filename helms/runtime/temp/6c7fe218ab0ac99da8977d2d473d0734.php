...
<div id="content" class="col-md-12">
	...
	<div class="pageheader">
		<h2>
			<i class="fa fa-tachometer"></i> 会员信息<span></span>
		</h2>
		...
		<div class="row">
			<div class="col-md-10">
				<section class="tile color transparent-white">
					...
					<div class="title-body" style="height: 100px;">
						...
						<div class="form-group">
							<label for="input01" class="col-sm-3 control-label">真实姓名</label>
							<div class="col-sm-3">
						...
						<div class="form-group">
							<label for="input01" class="col-sm-3 control-label">开通时间</label>
							<div class="col-sm-3">
									...
									<tr>
										<th style="width: 40px;">
											<div class="checkbox check-transparent">
												<input type="checkbox" id="allchck"> <label
													for="allchck2"></label>
											</div>
										</th>
