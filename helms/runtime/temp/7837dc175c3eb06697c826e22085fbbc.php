<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"D:\helms\tp5\public/../application/framework\view\adminopt\withdrawalapplication.html";i:1505058874;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
                ...
                <div class="col-md-10">
                 <section class="tile color transparent-white">
                  ...
                  <div class="tile-widget bg-transparent-white-2">
                      <form class="form-horizontal" role="form" action="WithdrawalApplicationQueryById" method="post" id="SubmitWithdrawalById">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-2">
                          <div class="input-group-btn">
                            <button type="submit" class="btn btn-default dropdown-toggle" data-toggle="dropdown">所有 <span class="caret"></span></button>
                            <ul class="dropdown-menu">
                              <li><a href="#">待审核</a></li>
                              <li><a href="#">已通过</a></li>
                              <li><a href="#">已完成</a></li>
                      ...
                      <form class="form-horizontal" role="form" action="WithdrawalApplicationQueryByTime" method="post" id="SubmitWithdrawalByTime">
                      <div class="form-group">
                        <label for="input01" class="col-sm-2 control-label">提现申请时间</label>
                        <div class="col-sm-2">
                          <input type="datetime-local" class="form-control" name="fromtime" id="fromtime">
                        </div>
                        <div class="col-sm-2">
                          <input type="datetime-local" class="form-control" name="totime" id="totime">
                        </div>
                      </div>
