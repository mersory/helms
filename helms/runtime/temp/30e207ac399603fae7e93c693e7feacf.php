...
<!--                   <li class="dropdown">
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="pageheader">
            <h2><i class="fa fa-tachometer"></i> 积分明细<span></span></h2>
                  ...
                  <div class="tile-widget bg-transparent-white-2">                      
                      ...
                      <div class="form-group form-footer">
                        <div class="col-sm-10 text-center">
                          <button type="submit" class="btn btn-primary" id="btn_point_details">搜索</button>
                        </div>
                      </div>
                  </div>
                  <!-- tile widget -->
                    ...
                    <table class="table table-custom" id="pointlist">
                      <thead>
                        <tr>
                          ...
                          <th class="sort-amount">复投分</th>
                          <th class="sort-amount">剩余点数</th>
