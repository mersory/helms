<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"D:\helms\tp5\public/../application/framework\view\adminopt\revenueexpenditure.html";i:1504885679;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
                ...
                <div class="col-md-10">
                 <section class="tile color transparent-white">
                  ...
                  <div class="tile-widget bg-transparent-white-2">
                      <form class="form-horizontal" role="form" action="RevenueExpenditureQuery" method="post" id="SubmitForm">
