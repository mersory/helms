<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:99:"E:\Software\php\workspace\helms\helms\public/../application/backend\view\common\pointstransfer.html";i:1521316965;s:90:"E:\Software\php\workspace\helms\helms\public/../application/backend\view\base\backend.html";i:1521316965;s:20:"base/common/css.html";i:1511359924;s:19:"base/common/js.html";i:1511676215;s:35:"base/common/backend/leftAndTop.html";i:1512005489;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
...
<script type="text/javascript">
	...
	<script type="text/javascript" src="_JS_/common/admin/pointtransform.js"></script>
...
<!--                   <li class="dropdown">
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="pageheader">
            <h2><i class="fa fa-tachometer"></i> 积分互转<span></span></h2>
            <div class="breadcrumbs">
              <ol class="breadcrumb">
                <li><a href="index.html">HERMS</a></li>
                <li class="active">积分互转</li>
              </ol>
            </div>
          </div>
          <!-- /page header -->
                 ...
                 <section class="tile color transparent-white">
                  ...
                  <div class="tile-widget bg-transparent-white-2">                      
                      <div class="form-group">
                        ...
                        <label for="input01" class="col-sm-2 control-label">积分转换时间</label>
                        <div class="col-sm-2">
                       ...
                       <div>
                          <input type="datetime-local" class="form-control" value="YYYY-MM-DDThh:mm:ss:s" id="point_transform_start">
                        </div>
                        <div>
                           <input type="datetime-local" class="form-control" value="YYYY-MM-DDThh:mm:ss:s" id="point_transform_end">
                        </div>
                      <div class="form-group form-footer">
                        <div class="col-sm-10 text-center">
                          <button type="submit" class="btn btn-primary" id="btn_point_transform">搜索</button>
                        </div>
                      </div>
                  </div>
                  <!-- tile widget -->
                  ...
                  <div class="tile-body no-vpadding">
                    ...
                    <table class="table table-custom" id="point_transform_list">
                      <thead>
                        <tr>
                          <th class="sort-asc">序号</th>
                          <th class="sort-asc">会员ID</th>
                          <th class="sort-numeric">积分转换类型</th>
                          <th class="sort-amount">转换金额</th>
                          <th class="sort-amount">积分转换时间</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
