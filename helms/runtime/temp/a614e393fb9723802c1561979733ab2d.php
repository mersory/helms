<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"D:\helms\tp5\public/../application/framework\view\adminopt\pointtransform.html";i:1505039888;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
                ...
                <div class="col-md-10">
                 <section class="tile color transparent-white">
                  ...
                  <div class="tile-widget bg-transparent-white-2">
                      <form class="form-horizontal" role="form" action="PointTransformQuery" method="post" id="SubmitForm">
