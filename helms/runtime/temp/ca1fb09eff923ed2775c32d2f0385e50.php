<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"C:\xampp\htdocs\tp5\public/../application/framework\view\useropt\updatepwd.html";i:1505311301;}*/ ?>
<?php
	session_start();
?>
<!DOCTYPE html>
      ...
      <div class="row">
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="pageheader">
            <h2><i class="fa fa-tachometer"></i> 修改密码<span></span></h2>
          ...
          <div class="main">
          	<div class="row">
                <div class="col-md-6">
				  ...
				  ?>
					<form action="PwdUpdateCommit" method="post" id="UpdatePwdForm">
							  <section>
				              ...
				              <section>
				                ...
				                <div class="input-group">
				                  <input type="password" class="form-control" name="comfirm">
				                  <div class="input-group-addon"><i class="fa fa-key"></i></div>
				                </div>
				              </section>
				              <section class="log-in">
				                 <input type="button" value="submitBtn" onclick="return submitForm();"/> 
				              </section>
				    </form>
                  </div>
                  <!-- /tile body -->
    ...
    <script src="_JS_/minimal.min.js"></script>
	 <script type="text/javascript">
	   function validate() 
	   {
			...
			var cfm = document.getElementsByName("comfirm");
			alert(pwd[0].value);
			alert(cfm[0].value);
			var password = pwd[0].value;
			if(pwd[0].value != cfm[0].value)
			{
				 alert("输入密码不一致");
				 return false;
			}
		    ...
		    {
			    alert("输入序列只能包含大、小写字母和数字");
			    return false;
		    }
			
			if( !((/[A-Z]/.test(password)) && (/[a-z]/.test(password)) && (/[0-9]/.test(password))) )
		    {
			   alert("输入序列必须包含大、小写字母和数字");
			   return false;
		    }
