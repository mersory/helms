...
<html>
  <head>
	...
	<script type="text/javascript" src="_JS_/common/admin/applicationlist.js"></script>
                ...
                <div class="col-md-10">
                 <section class="tile color transparent-white">
                  ...
                  <div class="tile-body no-vpadding">
                    ...
                    <table class="table table-custom" id="applyList_table">
                      <thead>
                        <tr>
