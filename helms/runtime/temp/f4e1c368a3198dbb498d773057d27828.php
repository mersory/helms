<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:101:"E:\Software\php\workspace\helms\helms\public/../application/backend\view\common\incomeandexpense.html";i:1521412450;s:90:"E:\Software\php\workspace\helms\helms\public/../application/backend\view\base\backend.html";i:1521316965;s:20:"base/common/css.html";i:1521411207;s:19:"base/common/js.html";i:1521411088;s:35:"base/common/backend/leftAndTop.html";i:1521409860;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
...
<div id="content" class="col-md-12">
	...
	<div class="pageheader">
		<h2>
			<i class="fa fa-tachometer"></i> 收支明细<span></span>
		</h2>
				...
				<section class="tile color transparent-white">
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<input type="datetime-local" class="form-control"
									id="income_expense_start">
							</div>
							<div class="col-sm-2">
								<input type="datetime-local" class="form-control"
									id="income_expense_end">
							</div>
						</div>
					</div>
					...
					<div class="tile-widget">
						<button type="button" class="btn btn-primary"
							id="btn_income_expend">搜索</button>
					</div>
					<!-- tile widget -->
