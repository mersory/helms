<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:96:"E:\Software\php\workspace\helms\helms\public/../application/frontend\view\adminopt\userlist.html";i:1505490519;s:92:"E:\Software\php\workspace\helms\helms\public/../application/frontend\view\base\frontend.html";i:1505490411;s:20:"base/common/css.html";i:1505486330;s:19:"base/common/js.html";i:1505486390;s:36:"base/common/frontend/leftAndTop.html";i:1505485766;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
    <title>HELMS - <block name="title">鏍囬</block></title>
    ...
    <script type="text/javascript" src="_JS_/common/userlist.js"></script>
                ...
                <div class="col-md-10">
                 <section class="tile color transparent-white">
                  ...
                  <div class="tile-widget bg-transparent-white-2">
                      <form class="form-horizontal" role="form" action="SearchUserInfo" method="post" id="SubmitForm">
                      
                      <div class="form-group">
                        <label for="userid" class="col-sm-2 control-label" >会员ID</label>
                        <div class="col-sm-2">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-2">
                          <input type="datetime-local" class="form-control" value="YYYY-MM-DDThh:mm:ss:s" name="fromtime" id="fromtime">
                        </div>
                        <div class="col-sm-2">
                          <input type="datetime-local" class="form-control" value="YYYY-MM-DDThh:mm:ss:s" name="totime" id="totime">
                        </div>
                      </div>
